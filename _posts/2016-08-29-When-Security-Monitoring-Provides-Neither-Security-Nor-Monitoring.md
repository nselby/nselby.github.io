...
<p>The box, the client told me, had been installed <em>three years earlier</em><label for="sn-demo" class="margin-toggle sidenote-number"></label><input type="checkbox" id="sn-demo" class="margin-toggle"/><span class="sidenote">Update: there is some confusion about this. The first comment during the event and call was that the box had been in place for three years. Later it seems that the MSSP had instructed, in email, the customer, on how and where to position the box only recently. What was clear was that the new team inherited the relationship with the MSSP from the old team, and that the box had been installed for a period of time prior to breach. Even if this is true, my comments about an affirmative responsibility on the part of the MSSP to alert the customer that the MSSP wasn't seeing traffic as expected stand. The MSSP claims that it did so inform the customer. The customer denied this to me in a telephone call yesterday afternoon. “I have no email on this,” said the CSO, “And I am on the distribution list that would mean I would have seen it.”</span>. And it wasn't the MSSP that discovered it, but rather the customer, and only after their hair was on fire.</p>
